...
//      ]
//    }
// } 'ул. Академика Королёва, дом ,12 1 подъезд ,15 этаж, кв. 253' to equal 'ул. Академика Королёва, дом 12, 1 подъезд, 15 этаж, кв. 253'.

function sendRequest(name, phone, address, goods, sum) {
    let data = {client:'', goods: [], order: {address:'', sum:0.00}};
